...
function ProductList({ onHomeClick }) {
  ...
  const [addedToCart, setAddedToCart] = useState({}); // <-- required
  ...
  const styleObj = {
    ...
    alignItems: 'center', // <-- fixed typo (was alignIems)
    fontSize: '20px',
  };
        ...
        <div style={styleObjUl}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <div
              ...
              aria-label={`Cart items: ${calculateTotalQuantity()}`}
            >
  ...
  reducers: {
    ...
    updateQuantity: (state, action) => {
      ...
      if (itemToUpdate) {
        ...
        // optional safety: if quantity drops to 0 or below, remove it
